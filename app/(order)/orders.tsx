...
//     setLoading(true);
//     try {
//       const token = await getToken() // adjust key if needed

//       const res = await fetch('https://docank.mahmoudalbatran.com/api/orders', {
//         method: 'GET',
//         headers: {
...
//   return (
//     <SafeView className="flex-1 bg-gray-50 px-4 pt-4">
//       <Text className="text-2xl font-bold text-neutral-600 mb-4 text-center py-5">
//         طلباتي
//       </Text>
